...
export const Qualification = () => {
  ...
  return (
    <section ref={ref} id="qualification-section" className="h-screen flex flex-col justify-around items-center py-12 lg:py-24">
      ...
      <div className="bg-white p-3 md:p-10 rounded-3xl mb-8 mt-5">
        <div className="flex justify-center mx-auto  px-16 py-4 bg-violet-400 rounded-xl md:text-2xl text-white font-bold shadow-xl">
