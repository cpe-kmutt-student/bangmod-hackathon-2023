...
const ImageInputBox = ({
    ...
    const border = "col-span-6 flex flex-col justify-center items-center h-40 border-dashed rounded-2xl border-2 border-violet-500 m-5 hover:border-violet-600 bg-white drop-shadow-lg"
    ...
    if(obj) return(
        <div className='grid grid-cols-1'>
            <div className='flex flex-col 
                            justify-start items-start h-1 m-5'>
                <ul>
