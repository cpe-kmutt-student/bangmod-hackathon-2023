...
export const ScopeSection = () => {
  ...
  const [isVisible, ref] = useInView<HTMLElement>({ threshold: 0.2 });

  useEffect(() => {
    isVisible && setVisibleSection('scope');
  }, [isVisible]);

  return (
    <section ref={ref} id="scope-section" className="h-full py-12 lg:py-24">
      ...
      <div className="bg-white p-3 md:p-10 rounded-3xl mb-8">
        <div className="w-full flex justify-center mx-auto py-4 bg-[#7c81be] rounded-xl text-md md:text-2xl text-white font-bold shadow-xl">
